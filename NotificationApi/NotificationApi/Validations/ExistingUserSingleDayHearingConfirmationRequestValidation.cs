...
{
    public class ExistingUserSingleDayHearingConfirmationRequestValidation : AbstractValidator<ExistingUserSingleDayHearingConfirmationRequest>
    {
        public ExistingUserSingleDayHearingConfirmationRequestValidation()
        {
