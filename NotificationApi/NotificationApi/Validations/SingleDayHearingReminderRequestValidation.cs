...
public class SingleDayHearingReminderRequestValidation : AbstractValidator<SingleDayHearingReminderRequest>
{
    public SingleDayHearingReminderRequestValidation()
    {
