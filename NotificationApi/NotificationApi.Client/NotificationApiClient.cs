...
namespace NotificationApi.Client
{
    ...
    public partial class NotificationApiClient 
    {
        ...
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<NotificationTemplateResponse> Notificiation_GetTemplateByNotificationTypeAsync(int notificationType)
        {
            return Notificiation_GetTemplateByNotificationTypeAsync(notificationType, System.Threading.CancellationToken.None);
        }
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<NotificationTemplateResponse> Notificiation_GetTemplateByNotificationTypeAsync(int notificationType, System.Threading.CancellationToken cancellationToken)
        {
