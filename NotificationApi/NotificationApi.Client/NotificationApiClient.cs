...
namespace NotificationApi.Client
{
    ...
    public partial interface INotificationApiClient
    {
        ...
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<NotificationResponse>> GetPasswordNotificationByEmailAsync(string email);
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.ICollection<NotificationResponse>> GetPasswordNotificationByEmailAsync(string email, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class NotificationApiClient : INotificationApiClient
    {
        ...
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.ICollection<NotificationResponse>> GetPasswordNotificationByEmailAsync(string email)
        {
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<System.Collections.Generic.ICollection<NotificationResponse>> GetPasswordNotificationByEmailAsync(string email, System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == 200)
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<System.Collections.Generic.ICollection<NotificationResponse>>(response_, headers_).ConfigureAwait(false);
                            if (objectResponse_.Object == null)
                            {
                                throw new NotificationApiException("Response was null which was not expected.", status_, objectResponse_.Text, headers_, null);
                            }
