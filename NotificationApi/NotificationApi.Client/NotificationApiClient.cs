...
namespace NotificationApi.Client
{
    ...
    public partial interface INotificationApiClient
    {
        ...
        /// <returns>Error if fails, otherwise OK status</returns>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<HealthResponse> CheckServiceHealthAuth2Async();
        ...
        /// <returns>Error if fails, otherwise OK status</returns>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<HealthResponse> CheckServiceHealthAuth2Async(System.Threading.CancellationToken cancellationToken);
        ...
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<NotificationTemplateResponse> GetTemplateByNotificationType2Async(NotificationType notificationType);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<NotificationTemplateResponse> GetTemplateByNotificationType2Async(NotificationType notificationType, System.Threading.CancellationToken cancellationToken);
        ...
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task CreateNewNotification2Async(AddNotificationRequest request);

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task CreateNewNotification2Async(AddNotificationRequest request, System.Threading.CancellationToken cancellationToken);
        ...
        /// </summary>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task HandleCallback2Async(NotificationCallbackRequest notificationCallbackRequest);
        ...
        /// </summary>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        System.Threading.Tasks.Task HandleCallback2Async(NotificationCallbackRequest notificationCallbackRequest, System.Threading.CancellationToken cancellationToken);
    ...
    public partial class NotificationApiClient : INotificationApiClient
    {
        ...
        /// <returns>Error if fails, otherwise OK status</returns>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<HealthResponse> CheckServiceHealthAuthAsync()
        {
        ...
        /// <returns>Error if fails, otherwise OK status</returns>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<HealthResponse> CheckServiceHealthAuthAsync(System.Threading.CancellationToken cancellationToken)
        {
        ...
        /// <returns>Error if fails, otherwise OK status</returns>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<HealthResponse> CheckServiceHealthAuth2Async()
        {
        ...
        /// <returns>Error if fails, otherwise OK status</returns>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<HealthResponse> CheckServiceHealthAuth2Async(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
        ...
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task<NotificationTemplateResponse> GetTemplateByNotificationType2Async(NotificationType notificationType)
        {
            return GetTemplateByNotificationType2Async(notificationType, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<NotificationTemplateResponse> GetTemplateByNotificationType2Async(NotificationType notificationType, System.Threading.CancellationToken cancellationToken)
        {
            if (notificationType == null)
                throw new System.ArgumentNullException("notificationType");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/v1/notification/template/{notificationType}");
            urlBuilder_.Replace("{notificationType}", System.Uri.EscapeDataString(ConvertToString(notificationType, System.Globalization.CultureInfo.InvariantCulture)));
        ...
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task CreateNewNotification2Async(AddNotificationRequest request)
        {
            return CreateNewNotification2Async(request, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task CreateNewNotification2Async(AddNotificationRequest request, System.Threading.CancellationToken cancellationToken)
        {
            if (request == null)
                throw new System.ArgumentNullException("request");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/v1/notification");
        ...
        /// </summary>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public virtual System.Threading.Tasks.Task HandleCallback2Async(NotificationCallbackRequest notificationCallbackRequest)
        {
            return HandleCallback2Async(notificationCallbackRequest, System.Threading.CancellationToken.None);
        }
        ...
        /// </summary>
        /// <exception cref="NotificationApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task HandleCallback2Async(NotificationCallbackRequest notificationCallbackRequest, System.Threading.CancellationToken cancellationToken)
        {
            if (notificationCallbackRequest == null)
                throw new System.ArgumentNullException("notificationCallbackRequest");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/v1/notification/callback");
